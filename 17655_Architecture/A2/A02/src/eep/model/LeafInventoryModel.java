 ...
 * @author walid
 */
public class LeafInventoryModel {
    
    private static LeafInventoryModel instance;
    
    public static LeafInventoryModel getInstance(){
        if (instance == null){
            instance = new LeafInventoryModel();
        }
    ...
    public String getCultureBoxes(String SQLServerIP) {
        return this.getProducts(SQLServerIP, "cultureboxes");
    }
    
    public String getGenomics(String SQLServerIP) {
        return this.getProducts(SQLServerIP, "genomics");
    }
    
    public String getProcessing(String SQLServerIP) {
        return this.getProducts(SQLServerIP, "processing");
    }
    
    public String getReferenceMaterials(String SQLServerIP) {
        return this.getProducts(SQLServerIP, "referencematerials");
    }
