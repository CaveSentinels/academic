...
import eep.controller.ShippingController;
import java.sql.*;
 ...
 * @author lattanze
 */
public class ShippingView extends javax.swing.JFrame {
    Integer updateOrderID;
    String versionID = "v3.0.0";
    private ShippingController controller;
    
    /** Creates new form NewJFrame */
    public ShippingView(ShippingController controller) {
    ...
    public ShippingView(ShippingController controller, String userName) {
        this(controller);
