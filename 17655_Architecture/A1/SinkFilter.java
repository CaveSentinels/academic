...
public class SinkFilter extends FilterFramework
{
    ...
    // Constructor takes the output file name
    ...
    void validateNumberOfPorts(){
        ...
        if(OutputWritePorts.size() > 0){
            throw new IllegalArgumentException("Sink filter cannot have output ports");
        }
    }
        ...
        try {
            ...
            while (true)
            {
                try
                {
                    ...
                    {
                        writer.print( "\t" + Double.longBitsToDouble(measurement) );
